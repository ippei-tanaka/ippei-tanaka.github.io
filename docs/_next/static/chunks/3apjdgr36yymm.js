(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,35066,90532,e=>{"use strict";let t={name:"local-uniform-bit",vertex:{header:`
    ...
    `}e.s(["uniformParsers",0,o],92715),e.s(["createUboSyncFunction",0,function(e,t,a,r){let f=[`
        var v = null;
        var v2 = null;
        var t = 0;
        var index = 0;
    ...
    `],i=0;for(let s=0;s<e.length;s++){let n=e[s],u=n.data.name,v=!1,l=0;for(let e=0;e<o.length;e++)if(o[e].test(n.data)){l=n.offset/4,f.push(`name = "${u}";`,`offset += ${l-i};`,o[e][t]||o[e].ubo),v=!0;break}if(!v)if(n.data.size>1)l=n.offset/4,f.push(a(n,l-i));else{let e=r[n.data.type];l=n.offset/4,f.push(`
        ...
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};e.s(["uboSyncFunctionsSTD40",0,i,"uboSyncFunctionsWGSL",0,s],33156);var n=e.i(95932),u=e.i(24314);class v extends n.default{constructor({buffer:e,offset:t,size:a}){super(),this.uid=(0,u.uid)("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=(0,u.uid)("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=e,this.offset=0|t,this.size=a,this.buffer.on("change",this.onBufferChange,this)}onBufferChange(){this._resourceId=(0,u.uid)("resource"),this.emit("change",this)}destroy(e=!1){this.destroyed=!0,e&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}e.s(["BufferResource",0,v],87784)}]);