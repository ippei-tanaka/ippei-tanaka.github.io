(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,35066,90532,e=>{"use strict";let t={name:"local-uniform-bit",vertex:{header:`
    ...
    `}e.s(["uniformParsers",0,o],92715),e.s(["createUboSyncFunction",0,function(e,t,a,r){let s=[`
        var v = null;
        var v2 = null;
        var t = 0;
        var index = 0;
    ...
    `],f=0;for(let n=0;n<e.length;n++){let i=e[n],u=i.data.name,v=!1,l=0;for(let e=0;e<o.length;e++)if(o[e].test(i.data)){l=i.offset/4,s.push(`name = "${u}";`,`offset += ${l-f};`,o[e][t]||o[e].ubo),v=!0;break}if(!v)if(i.data.size>1)l=i.offset/4,s.push(a(i,l-f));else{let e=r[i.data.type];l=i.offset/4,s.push(`
        ...
        data[offset + 2] = v[2];
        data[offset + 3] = v[3];
    `};e.s(["uboSyncFunctionsSTD40",0,f,"uboSyncFunctionsWGSL",0,n],33156);var i=e.i(95932),u=e.i(24314);class v extends i.default{constructor({buffer:e,offset:t,size:a}){super(),this.uid=(0,u.uid)("buffer"),this._resourceType="bufferResource",this._touched=0,this._resourceId=(0,u.uid)("resource"),this._bufferResource=!0,this.destroyed=!1,this.buffer=e,this.offset=0|t,this.size=a,this.buffer.on("change",this.onBufferChange,this)}onBufferChange(){this._resourceId=(0,u.uid)("resource"),this.emit("change",this)}destroy(e=!1){this.destroyed=!0,e&&this.buffer.destroy(),this.emit("change",this),this.buffer=null,this.removeAllListeners()}}e.s(["BufferResource",0,v],87784)},81735,e=>{"use strict";var t=e.i(27402),a=e.i(61411),r=e.i(48446);let o=new class{constructor(e){this._canvasPool=Object.create(null),this.canvasOptions=e||{},this.enableFullScreen=!1}_createCanvasAndContext(e,a){let r=t.DOMAdapter.get().createCanvas();r.width=e,r.height=a;let o=r.getContext("2d");return{canvas:r,context:o}}getOptimalCanvasAndContext(e,t,r=1){e=Math.ceil(e*r-1e-6),t=Math.ceil(t*r-1e-6),e=(0,a.nextPow2)(e),t=(0,a.nextPow2)(t);let o=(e<<17)+(t<<1);this._canvasPool[o]||(this._canvasPool[o]=[]);let s=this._canvasPool[o].pop();return s||(s=this._createCanvasAndContext(e,t)),s}returnCanvasAndContext(e){let{width:t,height:a}=e.canvas,r=(t<<17)+(a<<1);e.context.resetTransform(),e.context.clearRect(0,0,t,a),this._canvasPool[r].push(e)}clear(){this._canvasPool={}}};r.GlobalResourceRegistry.register(o),e.s(["CanvasPool",0,o])}]);